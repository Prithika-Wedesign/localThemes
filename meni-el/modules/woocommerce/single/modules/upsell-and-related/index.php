...
if( !class_exists( 'Meni_El_Shop_Single_Module_Upsell_Related' ) ) {

    class Meni_El_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( meni_el_is_file_in_theme( __FILE__ ) ) {
                    return MENI_EL_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( meni_el_is_file_in_theme( __FILE__ ) ) {
                    return MENI_EL_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'meni_el_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('meni_el_shop_single_module_upsell_related') ) {
	function meni_el_shop_single_module_upsell_related() {
		return Meni_El_Shop_Single_Module_Upsell_Related::instance();
	}
}

meni_el_shop_single_module_upsell_related();