...
if( !class_exists( 'Meni_El_Woo_Listing_Tag' ) ) {

    class Meni_El_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'meni_el_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('meni_el_woo_listing_tag') ) {
	function meni_el_woo_listing_tag() {
		return Meni_El_Woo_Listing_Tag::instance();
	}
}

meni_el_woo_listing_tag();