...
/* Customized script - 'meni_el_shop_products_list_class' function */
$columns = wc_get_loop_prop('columns');

$classes = apply_filters( 'meni_el_woo_listings_class', array () );
$classes = ( is_array ($classes) && !empty ($classes) ) ? implode( ' ', $classes ) : '';

$settings = meni_el_woo_listing_shop()->woo_default_settings();
extract($settings);
...
if( function_exists ( 'meni_el_woo_loop_column_class' ) ) {
	...
	<li class="product isotope-grid-sizer">
		<div class="<?php echo meni_el_woo_loop_column_class ( $columns ); ?>"></div>
	</li>
	<?php
}