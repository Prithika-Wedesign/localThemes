...
if( !class_exists( 'Meni_El_Woo_Listing_Type_Default' ) ) {

    class Meni_El_Woo_Listing_Type_Default {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Default', 'meni-el');
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( meni_el_is_file_in_theme( __FILE__ ) ) {
                    return MENI_EL_MODULE_DIR . '/woocommerce/listings/types/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( meni_el_is_file_in_theme( __FILE__ ) ) {
                    return MENI_EL_MODULE_URI . '/woocommerce/listings/types/';
                } else {
        ...
        */
            function render_backend() {
                ...
                /* Custom Product Templates - Options */
                    add_filter( 'meni_el_woo_default_product_templates', array( $this, 'woo_default_product_templates'), 10, 1 );
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    'id'              => 'meni_el-woo-product-style-template-'.$this->type_slug,
                    'type'            => 'group',
                    'meni_el_default_type' => true,
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'meni-el' ), $this->type_name ),
                    'button_title'    => esc_html__('Add New', 'meni-el'),
                    'accordion_title' => esc_html__('Add New Template', 'meni-el'),
                    'fields'          => meni_el_woo_listing_fw_template_settings()->woo_get_options_params( $type_options, 'default' ),
        ...
        */
            function render_frontend() {
                ...
                if( $non_archive_listing ) {
                    ...
                    /* Types CSS */
                        add_filter( 'meni_el_woo_non_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );

                } else {

                    /* Types CSS */
                        add_filter( 'meni_el_woo_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'meni_el-woo-non-archive', '', array (), MENI_EL_THEME_VERSION, 'all' );
                        wp_enqueue_style( 'meni_el-woo-non-archive' );
                        ...
                        $css = apply_filters( 'meni_el_woo_non_archive_css', $css );

                        if( !empty($css) ) {
                            wp_add_inline_style( 'meni_el-woo-non-archive', $css );
                        }

                    // JS

                        wp_register_script( 'meni_el-woo-non-archive', '', array ('jquery'), false, true );
                        wp_enqueue_script( 'meni_el-woo-non-archive' );
                        ...
                        $js = apply_filters( 'meni_el_woo_non_archive_js', $js );

                        if( !empty($js) ) {
                            wp_add_inline_script( 'meni_el-woo-non-archive', $js );
                        }
...
if( !function_exists('meni_el_woo_listing_type_default') ) {
	function meni_el_woo_listing_type_default() {
		return Meni_El_Woo_Listing_Type_Default::instance();
	}
}

meni_el_woo_listing_type_default();