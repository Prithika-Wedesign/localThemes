...
if( ! function_exists( 'meni_el_shop_woo_loop_product_content' ) ) {

	function meni_el_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				meni_el_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('meni_el_woo_loop_product_content_content', 'content');
					remove_all_actions('meni_el_woo_loop_product_content_content');
				echo '</div>';
	...
	add_action( 'woocommerce_shop_loop_item_title', 'meni_el_shop_woo_loop_product_content', 10 );
