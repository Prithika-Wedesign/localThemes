...
if( !class_exists( 'Meni_El_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Meni_El_Woo_Listing_Option_Thumb_Element_Group extends Meni_El_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'meni_el_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('meni_el_woo_listing_option_thumb_element_group') ) {
	function meni_el_woo_listing_option_thumb_element_group() {
		return Meni_El_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

meni_el_woo_listing_option_thumb_element_group();