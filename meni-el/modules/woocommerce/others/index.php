...
if( !class_exists( 'Meni_El_Woo_Others' ) ) {

    class Meni_El_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'meni_el_woo_others_settings', $this->settings );
...
if( !function_exists('meni_el_woo_others') ) {
	function meni_el_woo_others() {
		return Meni_El_Woo_Others::instance();
	}
}
