...
if( !class_exists( 'Meni_El_Woo_Listing_Shop' ) ) {

    class Meni_El_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'meni_el_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('meni_el_woo_listing_shop') ) {
	function meni_el_woo_listing_shop() {
		return Meni_El_Woo_Listing_Shop::instance();
	}
}

meni_el_woo_listing_shop();