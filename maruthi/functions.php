...
add_action( 'after_setup_theme', 'maruthi_i18n' );
if (! function_exists('maruthi_i18n')) {
    function maruthi_i18n() {
        load_theme_textdomain( 'maruthi', MARUTHI_THEME_DIR . '/languages' );
    }
}


if (! function_exists('maruthi_load_theme_files')) {
    function maruthi_load_theme_files() {
...
add_action( 'after_setup_theme', 'maruthi_load_theme_files', 20 );